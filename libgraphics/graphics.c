...
static void InitColors(void)
{
	...
	//自己增加区域
	DefineColor("Cream", .8392156, .8117647, .69803921);
	DefineColor("Pinkish", .866666666, .6, .52549019);
	DefineColor("LightYell", .94509803, .83921568, .53725490);//Light yellow
	DefineColor("ThickYell", .972549019, .85882352, .01960784);
	DefineColor("Orange", .984313725, .63137254, .1921568627);
	DefineColor("SeaBlue", .20784313, .4313725490, .8352941176);
	DefineColor("DarkBlue", .01568627, .098039, .360784);
	DefineColor("LightPur", .827450, .788235, .88627450);//light purple
	DefineColor("CyanGray", .6745098, .733333, .76078431);
}
